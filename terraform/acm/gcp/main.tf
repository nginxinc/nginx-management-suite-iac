...
resource "google_compute_instance" "acm_example" {
  name         = "acm-example"
  ...
  metadata = {
    ...
    startup-script = templatefile("${path.root}/../templates/startup.sh.tmpl", { base64 = module.acm_common.htpasswd_data.content_base64 })
  }
